...
/**
 * The actual Cave Rave
 * //still need to fix the oval hitboxes
 * @author (Matt Barton) 
 * @version (10/24/16)
 */
public class Rave extends Applet implements Runnable, KeyListener
{
    Thread flapper;
    ...
    public void paint(Graphics g)
    {
        ...
        {
            int eqq = ((w3+w2)/2);
            g.fillOval(t*2,500-y2,eqq,eqq);
            g.fillOval(t*3/2,500-y2,(2*w+w2)/2,(2*w+w2)/2);
